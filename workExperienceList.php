            ...
            <table class="table vertical-align: middle table-bordered m-4 col-10 ">
                <?php
                    if(isset($_SESSION['first_name']) && isset($_SESSION['last_name']))
                    {
                        ...
                        if (mysqli_num_rows($result)>0) 
                        {
                            ...
                            {
                                $query2="SELECT `title`, `employer` FROM `cvbuilder`.`user_work_details` WHERE `work_id`='$rows[work_id]'";
                ...
                <?php
                        ...
                        if(isset($_POST['delete'])){
                            $queryDel1="DELETE FROM `cvbuilder`.`user_work_details` WHERE `work_id`='$_POST[work_id]'";
                            $result1 = mysqli_query($conn, $queryDel1); 
                            if($result1){
                                $queryDel2="DELETE FROM `cvbuilder`.`user_work_mapping` WHERE `work_id`='$_POST[work_id]'";
